...
MemIPC::Data BiMemIPC::read() { return m_ReadChn.read(); }

char *BiMemIPC::openData(size_t Len) { return m_WriteChn.openData(Len); }

void BiMemIPC::finishData(size_t Len) { m_WriteChn.closeData(Len); }
