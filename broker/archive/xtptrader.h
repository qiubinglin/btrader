...
// class XTPTrader : public TradeService, public XTP::API::TraderSpi {
//  public:
//   XTPTrader(const Json::json &cfg);
//   ~XTPTrader();

//   bool insert_order(const OrderInput &in) override;
//   bool cancel_order(const OrderAction &in) override;
